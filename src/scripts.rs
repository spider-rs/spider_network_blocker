...
lazy_static::lazy_static! {
    ...
    pub static ref URL_IGNORE_TRIE: Trie = {
        ...
        let patterns = [
            ...
            "https://static.adsafeprotected.com/publisher/",
    ...
    pub static ref URL_IGNORE_EMBEDED_TRIE: Trie = {
        let mut trie = Trie::new();
        let patterns = [
    ...
    pub static ref URL_IGNORE_SCRIPT_BASE_PATHS: Trie = {
        let mut trie = Trie::new();
        let patterns = [
    ...
    pub static ref URL_IGNORE_SCRIPT_STYLES_PATHS: Trie = {
        let mut trie = Trie::new();
        let patterns = [
            "wp-content/themes/",
    ...
    pub static ref URL_IGNORE_TRIE_PATHS: Trie = {
        let mut trie = Trie::new();
        let patterns = [
            // explicit ignore tracking.js and ad files
            "privacy-notice.js",
